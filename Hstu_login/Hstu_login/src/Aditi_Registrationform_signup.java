...
public class Aditi_Registrationform_signup extends JFrame {
    ...
    public Aditi_Registrationform_signup() {
        ...
        registerButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {// kaj suru
                registeruser();
   ...
   private void registeruser() {
    ...
    private User addUserToDatabase( String name,String stid,String depart,String level,String semest,String degree,String password,String conpass) {
        ...
        try {
            ...
            new Aditi_Registrationform_signup();
    ...
    public static void main(String[] args) {
        Aditi_Registrationform_signup Reg=new Aditi_Registrationform_signup();
        //User user=Reg.user;
